...
#ifndef TALCS_AACFORMATENTRY_H
#define TALCS_AACFORMATENTRY_H
...
namespace talcs {
    ...
    class TALCSWIDGETS_EXPORT AACFormatEntry : public FormatEntry {
        Q_OBJECT
    public:
        explicit AACFormatEntry(QObject *parent = nullptr);
        ~AACFormatEntry() override;
